...
if object_search_input:
    # Prepare user input for a flexible search
    search_query = object_search_input.lower().replace(" ", "")
    
    for obj in CELESTIAL_DATA:
        # Prepare celestial data fields for comparison
...
with st.sidebar.form("new_observation_form"):
    # Form fields now reflect the found object
    ...
    # Additional info fields (RA, Dec, etc.)
